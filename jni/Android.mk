...
LOCAL_SRC_FILES := gsl-1.9/lib/libgslcblas.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := gsl
LOCAL_SRC_FILES := gsl-1.9/lib/libgsl.a
...
include $(CLEAR_VARS)
LOCAL_MODULE := jpeg6b
LOCAL_SRC_FILES := jpeg-6b/lib/libjpeg.a
include $(PREBUILT_STATIC_LIBRARY)
...
include $(LOCAL_PATH)/OpenCV-2.4.0/share/OpenCV/OpenCV.mk
...
include $(CLEAR_VARS)
LOCAL_MODULE := stasm
LOCAL_SRC_FILES := 	stasm3.1/stasm/asmsearch.cpp \
	stasm3.1/stasm/initasm.cpp \
	stasm3.1/stasm/readasm.cpp \
	stasm3.1/stasm/err.cpp \
	stasm3.1/stasm/util.cpp \
	stasm3.1/rowley/forward.cpp \
	stasm3.1/rowley/initnet.cpp \
	stasm3.1/stasm/safe_alloc.cpp \
	stasm3.1/mat/mat.cpp \
	stasm3.1/mat/mchol.cpp \
	stasm3.1/stasm/atface.cpp \
	stasm3.1/tasm/mrand.cpp \
	stasm3.1/stasm/shapefile.cpp \
	stasm3.1/mat/matvec.cpp \
	stasm3.1/image/imequalize.cpp \
	stasm3.1/jpeg/wrbmp.c \
	stasm3.1/image/jpegutil.cpp \
	stasm3.1/image/imfile.cpp \
	stasm3.1/image/imwrite.cpp \
	stasm3.1/image/imgiven.cpp \
	stasm3.1/image/imutil.cpp \
	stasm3.1/image/rgbimutil.cpp \
	stasm3.1/stasm/imshape.cpp \
	stasm3.1/tasm/tasm.cpp \
	stasm3.1/stasm/landmarks.cpp \
	stasm3.1/stasm/prof.cpp \
	stasm3.1/stasm/readconf.cpp \
	stasm3.1/stasm/release.cpp \
	stasm3.1/rowley/tclHash.c \
	stasm3.1/rowley/search.cpp \
	stasm3.1/rowley/follow.cpp \
	stasm3.1/rowley/find.cpp \
	stasm3.1/stasm/rowley.cpp \
	stasm3.1/stasm/rowleyhand.cpp \
	stasm3.1/stasm/shapemodel.cpp \
	stasm3.1/stasm/sparsemat.cpp \
	stasm3.1/stasm/startshape.cpp \
	stasm3.1/stasm/tab.cpp \
	stasm3.1/stasm/violajones.cpp \
	stasm3.1/stasm/vjhand.cpp \
	stasm3.1/tasm/eyesynth.cpp \
	stasm3.1/tasm/proftrain.cpp \
	stasm3.1/stasm/stasm.cpp \
	stasm3.1/tasm/detav.cpp \
	stasm3.1/tasm/tasmshapes.cpp \
	stasm3.1/tasm/tcovar.cpp \
	stasm3.1/rowley/list.cpp \
	stasmlib.cpp

LOCAL_C_INCLUDES := \
        $(LOCAL_PATH)/gsl-1.4/include \
    	$(LOCAL_PATH)/stasm3.1/gsl\
    	$(LOCAL_PATH)/stasm3.1/gsl/gsl\
    	$(LOCAL_PATH)/stasm3.1/image\
    	$(LOCAL_PATH)/stasm3.1/mat\
    	$(LOCAL_PATH)/stasm3.1/rowley\
    	$(LOCAL_PATH)/stasm3.1/stasm\
    	$(LOCAL_PATH)/stasm3.1/tasm \
    	$(LOCAL_PATH)/OpenCV-2.4.0/include \
    	$(LOCAL_PATH)/OpenCV-2.4.0/include/opencv \
    	$(LOCAL_PATH)/jpeg-6b/include
...
LOCAL_LDFLAGS := -L$(LOCAL_PATH)/OpenCV-2.4.0/libs -lm -lz -llog -ljnigraphics

LOCAL_STATIC_LIBRARIES := jpeg6b gsl gslcblas utils opencv_objdetect libopencv_calib3d opencv_features2d opencv_flann opencv_imgproc opencv_core opencv_highgui cvaux libjasper libpng libjpeg libtbb libtiff
...
LOCAL_MODULE    := opencv4android

LOCAL_STATIC_LIBRARIES := utils opencv_objdetect libopencv_calib3d opencv_features2d opencv_flann opencv_imgproc opencv_core opencv_highgui cvaux libjasper libpng libjpeg libtbb libtiff
